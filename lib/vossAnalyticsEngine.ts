...
const TITLES: Record<number, string[]> = {
  ...
  2: [
    ...
    "Institutional-Grade Copy Attesting", "Smart Money Wallet Classifier", "Protocol Revenue Dashboard",
  ...
  3: [
    "Whale Network X (Twitter) Viral Engine", "Institutional Press Kit Grid", "CMC/CoinGecko SEO Domination",
...
const DESCRIPTIONS: Record<number, string[]> = {
  ...
  5: [
    ...
    "Kaiko integration for OTC market depth and institutional bid/ask spreads that improve the context of Whale Networks.",
