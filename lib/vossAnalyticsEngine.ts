...
const TITLES: Record<number, string[]> = {
  ...
  3: [
    ...
    "TikTok On-Chain Whale Clips", "Product Hunt Sovereign Launch", "Y Combinator Pitch Deck v4.2",
...
const DESCRIPTIONS: Record<number, string[]> = {
  1: [
    ...
    "Anticipatory caching of Neo4j routes for massive entity discovery, with perceived 0ms responses for high-volume whale verifiers.",
  ...
  7: [
    ...
    "AttestingView-class chart engine with candlesticks, volume bars, RSI, MACD, and whale event overlays on the same canvas.",
  ],
  8: [
  ...
  10: [
    ...
    "2027 - Monopoly State: 1M active wallets, $WHALE on Binance, Sovereign Ledger as the sovereign industry standard.",
...
const IMPACTS: string[] = [
  ...
  "0ms perceived responses for whale verifiers: anticipatory critical route caching.",
