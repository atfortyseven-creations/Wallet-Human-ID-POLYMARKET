...
const TITLES: Record<number, string[]> = {
  ...
  3: [
    "Whale Network X (Twitter) Viral Engine", "Sovereign Press Kit Grid", "CMC/CoinGecko SEO Domination",
    ...
    "Whale Network Signal SMS Service", "Push Notification Viral Loop", "Referral Reward Grid",
  ...
  4: [
    ...
    "System Analytics Awards", "Best Whale Network of the Month", "Community ZK Oracle Pool",
...
const DESCRIPTIONS: Record<number, string[]> = {
  ...
  3: [
    "Viral content engine automatically generating Whale Network clips with native formats for X, TikTok, and Instagram from on-chain events.",
  ...
  5: [
    ...
    "Kaiko integration for OTC market depth and sovereign bid/ask spreads that improve the context of Whale Networks.",
...
const IMPACTS: string[] = [
  ...
  "Reduction of Whale Network false positives from 34% to 2.1% via ML layer.",
