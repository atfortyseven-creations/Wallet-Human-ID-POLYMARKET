...
class LedgerAudioEngine {
  ...
  public async playLedgerSonar(intensity: number = 1) { return; }
  public async playSubtleBlip() { return; }
}

// Singleton  only created client-side
export const ledgerAudio = typeof window !== 'undefined' ? new LedgerAudioEngine() : null;
