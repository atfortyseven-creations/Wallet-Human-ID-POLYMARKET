...
export const NODE_SOLUTIONS: NodeSolution[] = [
    ...
    { id: 'btc', name: 'Bitcoin', description: 'The original decentralised digital currency.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Mainnet', 'Testnet'], category: 'NON-EVM' },
    ...
    { id: 'btc-cash', name: 'Bitcoin Cash', description: 'Decentralised peer-to-peer electronic cash.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Mainnet', 'Testnet'], category: 'NON-EVM' },
    ...
    { id: 'zcash', name: 'ZCash', description: 'Privacy-preserving decentralised finance.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Mainnet'], category: 'NON-EVM' },
    ...
    { id: 'filecoin', name: 'Filecoin', description: 'Decentralised storage network for Web3.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Mainnet'], category: 'NON-EVM' },
    ...
    { id: 'akash', name: 'Akash', description: 'Decentralised open source cloud computing.', price: '$1000', performance: ['Standard'], mode: ['Archive', 'Full'], networks: ['Mainnet'], category: 'NON-EVM' },
    { id: 'allora', name: 'Allora', description: 'Analytics-driven decentralised network.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Testnet'], category: 'NON-EVM' },
