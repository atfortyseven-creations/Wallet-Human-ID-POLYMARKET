...
const COURSES = [
    {
        id: 'ledger-basics',
        title: 'Ledger Analytics Fundamentals',
        description: 'Learn how to identify and track sovereign ledger wallets, interpret on-chain signals, and build your first watchlist.',
        totalDuration: '2h 30m', badge: 'Popular', level: 'Beginner',
        lessons: [
            { id: 'w1', title: 'What is a Ledger?', duration: '8m', level: 'Beginner', description: 'Defining sovereign wallets vs retail. Size thresholds and behavioral patterns.', orderIndex: 1 },
