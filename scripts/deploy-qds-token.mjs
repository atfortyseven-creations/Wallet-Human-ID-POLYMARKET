...
function createV5CompatFetch(nodeUrl) {
  ...
  const transformRequest = async (req) => {
    ...
    // ── Mapping 5: registerContractFunctionSignatures ───────────────────────
    // V5 testnet node removed this method, return success trivially.
    if (method === 'node_registerContractFunctionSignatures' || method === 'aztec_registerContractFunctionSignatures') {
