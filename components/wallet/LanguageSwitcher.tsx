                    ...
                    <>
                        ...
                        >
                            ...
                            <button 
                                ...
                                className={`w-full text-left px-4 py-3 text-sm font-bold hover:bg-[#F5F5F0] transition-colors flex justify-between items-center ${locale === 'es' ? 'text-[#1F1F1F]' : 'text-[#1F1F1F]/50'}`}
                            >
                                Español
                                {locale === 'es' && <div className="w-1.5 h-1.5 rounded-full bg-green-500" />}
                            </button>
                        </motion.div>
                    </>
                )}
