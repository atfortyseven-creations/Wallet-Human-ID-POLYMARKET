...
export const TacticalLedgerDatabase: React.FC<{ onClose: () => void }> = ({ onClose }) => {
            ...
            >
                ...
                <div className="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Ledger Activity Ledger</h2>
