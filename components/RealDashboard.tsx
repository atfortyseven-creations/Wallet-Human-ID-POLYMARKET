    ...
    return (
        <div className="max-w-md mx-auto py-10 px-6 space-y-8 animate-in fade-in">
            ...
            <div className="bg-black text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden">
                ...
                {txHash && <a href={`https://testnet.aztecscan.xyz/tx-effect/${txHash}`} target="_blank" className="block text-center text-xs text-blue-400 mt-4 underline">Ver en Aztecscan</a>}
            </div>
