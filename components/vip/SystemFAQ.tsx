...
const FAQ_DATA: FAQItem[][] = [
    ...
    [
        { q: "Whale Network v1.0: What is the current focus?", a: "Maximum sterilization of the interface and sub-15ms sync for institutional-grade terminals.", tag: "UPDATE" },
