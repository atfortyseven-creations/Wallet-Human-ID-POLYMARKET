...
const FAQ_DATA: FAQItem[][] = [
    ...
    [
        { q: "How does Humanity Ledger exceed standard transaction tracking?", a: "While explorers provide raw ledger data, we provide forensic reconstruction of intents. Our engine decodes complex multichain sequences that explorers often mislabel as generic transfers.", tag: "ARCHITECTURE" },
    ...
    [
        { q: "How does our forensic engine differ from attestation tools?", a: "Attestation tools are focused on reporting; we are focused on alpha. We prioritize identifying profit-driving movements over mere regulatory reporting.", tag: "SECURITY" },
        ...
        { q: "How do we identify sovereign migrations?", a: "Our system maintains a database of 2.4 million identified sovereign wallets, updated every 10 minutes by our stochastic engine.", tag: "DATA" },
        ...
        { q: "What is the advantage of our 'Ivory-and-Ink' theme?", a: "It is designed for sovereign focuseliminating visual noise while highlighting critical delta changes with high-contrast tactical accents.", tag: "UX" },
        ...
        { q: "How do we detect automated market-making?", a: "We identify HFT signatures that indicate automated accumulation vs. manual sovereign disposals.", tag: "ALGORITHMS" }
    ],
    ...
    [
        ...
        { q: "Do we provide API access for hedge funds?", a: "Yes, our Sovereign API offers raw data streams with 99.99% uptime and <10ms internal processing overhead.", tag: "API" },
    ...
    [
        ...
        { q: "Can the system detect stealth token launches?", a: "We monitor new contract deployments with initial liquidity >50 ETH to identify early sovereign-backed projects.", tag: "LAUNCHES" },
        ...
        { q: "Is the system compatible with Uniswap V4 hooks?", a: "Our engine is ready to analyze hooks for fee-dynamic adjustments that sovereign actors use to minimize attest impact.", tag: "V4" },
        ...
        { q: "What is the 'Yield Farmer' Protocol?", a: "Identification of $1M+ capital entries into new yield optimizers, indicating high-risk high-reward sovereign interest.", tag: "YIELD" }
    ],
    ...
    [
        ...
        { q: "Does the system monitor Base (Coinbase L2)?", a: "Full integration with the Base sequencer to identify sovereign onboarding from the Coinbase ecosystem.", tag: "L2" },
        ...
        { q: "Is there support for 'Modular Blockchains' like Celestia?", a: "We analyze DA (Data Availability) layers to estimate the cost of transaction throughput for sovereign builders.", tag: "MODULAR" },
        ...
        { q: "What is the 'Multi-Chain Portfolio' view?", a: "A unified dashboard showing total holdings across 20+ supported networks in a single sovereign view.", tag: "PORTFOLIO" }
    ],
    // PAGE 6: Sovereign Asset Selection
    [
        { q: "How do we select which assets are tracked?", a: "We prioritize assets by 'System Volatility'liquid assets where sovereign behavior has a statistically significant impact on price trajectory.", tag: "ASSETS" },
        { q: "Can the system track obscure ERC-20 tokens?", a: "While we index all, we only flag those meeting a minimum $1M 'Sovereign Depth' threshold to avoid distraction.", tag: "FILTER" },
    ...
    [
        { q: "How many layers deep can the forensic engine trace?", a: "Up to 50 hops, resolving complex multi-address fragmentation used to hide the origin of sovereign funds.", tag: "DEPTH" },
        ...
        { q: "What is the 'System Audit' trail?", a: "A downloadable PDF report of any event, suitable for sovereign attestation and internal risk review.", tag: "ATTESTATION" },
    ...
    [
        { q: "Is the Humanity Ledger system compliant with GDPR?", a: "Yes. We analyze public ledger data only and do not associate any PII (Personally Identifiable Information) with wallet addresses.", tag: "PRIVACY" },
    ...
    // PAGE 9-10: Diverse sovereign content
    [
        { q: "Humanity Ledger v1.0: What is the current focus?", a: "Maximum sterilization of the interface and sub-15ms sync for sovereign-grade terminals.", tag: "UPDATE" },
        { q: "Sovereign Pipeline: How do we process 1M events?", a: "Using an event-driven Kafka architecture that ensures zero message loss even during peak volatility.", tag: "PIPE" },
        ...
        { q: "API Performance: 99.99% Uptime SLA?", a: "Our globally redundant load balancers ensure sovereign reliability during high-stress periods.", tag: "API" },
        ...
        { q: "Atomic Execution: What is a flash-sync event?", a: "When the entire Humanity Ledger synchronizes a high-impact move across all clients in under 100ms.", tag: "SYNC" },
        ...
        { q: "Financial Freedom: Why Systemty matters?", a: "Information is the ultimate weapon in the Web3 space. Our tools empower individuals with sovereign-grade data.", tag: "MISSION" }
    ],
    [
        ...
        { q: "Tier Definitions: Standard vs Pro?", a: "Standard (Core), Pro (Sovereign), Elite (Cryptographic). Each has distinct alert priority levels.", tag: "TIERS" },
        ...
        { q: "Sovereign Alpha: Can I use this for arbitrage?", a: "While not a attesting platform, the raw data provides the necessary 'first-to-know' advantage required for alpha capture.", tag: "ATTESTING" },
        { q: "System Customization: Can I change the UI theme?", a: "The Ivory-and-Ink theme is our definitive master-spec for maximum clarity and sovereign focus.", tag: "UI" },
        { q: "Data Preservation: Is history archived?", a: "We maintain 10 years of sovereign history on Arweave to ensure that forensic data is permanent and immutable.", tag: "HISTORY" },
        { q: "Community Governance: Who owns the system?", a: "The System Infrastructure Group manages the protocol with oversight from the DAO of sovereign participants.", tag: "DAO" }
    ]
];
