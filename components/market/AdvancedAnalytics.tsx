            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white/5 rounded-xl border border-white/5 p-4 relative group">
                    ...
                    <div className="absolute bottom-4 left-4 text-[10px] font-mono text-[#00ff9d] flex items-center gap-1.5 opacity-50 group-hover:opacity-100 transition-opacity">
                        ...
                        WebSocket Connected: wss://feed.humanid.fi/v1/stream
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/5 rounded-xl border border-white/5 p-4">
                        ...
                        <div className="h-32 grid grid-cols-12 gap-0.5 opacity-80">
                            {Array.from({ length: 48 }).map((_, i) => (
                                <div 
                                    key={i} 
                                    className="rounded-[1px] transition-all hover:scale-125 hover:z-10"
                                    style={{
                                        backgroundColor: `rgba(${255}, ${Math.random() > 0.8 ? 50 : 255}, 50, ${Math.random()})`
                                    }}
                                />
                            ))}
                        </div>
                        <div className="mt-2 text-center text-xs font-mono text-red-400">
                            $1.2M Liquidated (Shorts) in last 10m
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-xl border border-white/5 p-4 flex-1">
                        ...
                        <div className="space-y-3">
                            <WhaleRow amount="500 BTC" action="Move" time="2s ago" />
                            <WhaleRow amount="12,000 ETH" action="Buy" time="5s ago" />
                            <WhaleRow amount="2M USDC" action="Mint" time="12s ago" />
                            <WhaleRow amount="450 BTC" action="Sell" time="45s ago" />
                        </div>
                    </div>
                </div>
            </div>
