...
export function LedgerSonar() {
    // =========================================================================
    // INJECTED DATA HOOK  Zero-Mock Mandate
    // Ledger stream endpoint injected via REGISTRY.Private_INTEL.massTransfers
    // =========================================================================
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 border-b border-[#E5E5E5]  pb-4 mb-4">
                ...
                <h2 className="text-sm font-aztec-mono font-black uppercase tracking-[0.2em] text-[#050505] ">Ledger Sonar</h2>
            </div>
