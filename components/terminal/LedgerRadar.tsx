...
export default function LedgerRadar() {
  ...
  useEffect(() => {
    ...
    // Real-time tracking of large USDC transfers (Ledger movements > $1M)
  ...
  return (
    <div className="mt-6">
      <h3 className="font-mono text-[10px] text-emerald-400 mb-2">LIVE LEDGER ACTIVITY (USDC &gt;1M)</h3>
