...
import { useNetworkStatus } from '@/components/chat/WhaleChatNetworkBadge';
...
interface WhaleChatStoriesProps {
  stories: PeerStories[];
...
export function WhaleChatStories({ stories, initialPeerIndex = 0, onClose, myAddress }: WhaleChatStoriesProps) {
