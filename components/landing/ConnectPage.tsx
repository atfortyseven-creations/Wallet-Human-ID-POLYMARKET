...
export default function ConnectPage() {
  ...
  // The old code went directly to /terminal without calling system-verify,
  ...
  return (
    <div className="w-full min-h-screen flex flex-col relative overflow-y-auto overflow-x-hidden" style={{ background: 'transparent' }}>
      ...
      <div className="relative z-10 w-full flex-1 flex flex-col items-center justify-center gap-[80px] px-4 py-8 min-h-screen" style={{ pointerEvents: 'none' }}>
        ...
        {/* ── TOP: Login Panel ── */}
        <div className="w-[380px] flex-shrink-0 flex flex-col bg-white/95 backdrop-blur-md rounded-[24px] border border-[#F0F0F0] shadow-[0_8px_60px_rgba(0,0,0,0.22)] p-8 z-20" style={{ pointerEvents: 'all' }}>
          ...
          <div className="flex items-center gap-3 mb-8 pb-5 border-b border-black/5">
            ...
            <Link href="/terminal" className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-600 font-black rounded-lg text-[10px] uppercase tracking-widest hover:bg-blue-100 transition-all active:scale-95 shadow-sm">
              <QrCode size={12} />
              Studio
            </Link>
          </div>
        ...
        {/* ── BOTTOM: Whale Network Info + Coming Soon Panel ── */}
        <div className="w-[380px] flex-shrink-0 flex flex-col gap-4" style={{ pointerEvents: 'all' }}>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col gap-3 items-center">
            ...
            <div className="flex items-center gap-3 w-full justify-center">
              ...
              <div className="flex items-center gap-2 px-3 py-2 bg-black/[0.04] rounded-xl border border-black/5">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-black">Android</span>
              </div>
              {/* Chrome Ext */}
              <div className="flex items-center gap-2 px-3 py-2 bg-black/[0.04] rounded-xl border border-black/5">
                <svg viewBox="0 0 24 24" className="w-4 h-4 text-black" fill="currentColor">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-black">Chrome</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 justify-center">
            <a href="https://github.com/whalenetwork" target="_blank" rel="noopener noreferrer" className="flex flex-1 items-center justify-center gap-2 px-3 py-3 rounded-2xl bg-white shadow-lg text-black hover:-translate-y-0.5 transition-all">
            ...
            <a href="https://t.me/humanityledger" target="_blank" rel="noopener noreferrer" className="flex flex-1 items-center justify-center gap-2 px-3 py-3 rounded-2xl bg-white shadow-lg text-[#2AABEE] hover:-translate-y-0.5 transition-all">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.94z"/>
              </svg>
            </a>
            <a href="https://linkedin.com/in/stefan-antonio-cirisanu" target="_blank" rel="noopener noreferrer" className="flex flex-1 items-center justify-center gap-2 px-3 py-3 rounded-2xl bg-white shadow-lg text-[#0A66C2] hover:-translate-y-0.5 transition-all">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
