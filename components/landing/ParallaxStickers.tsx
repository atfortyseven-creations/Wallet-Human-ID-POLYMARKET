...
const STICKERS = [
    ...
    { src: '/models/cat12.png', alt: 'Cat', size: 80 },
];
...
export function ParallaxStickers() {
    ...
    const stickersData = [
        ...
        { x: '25%', baseY: 500, speed: 0.4, rotate: 10, src: STICKERS[2].src, size: STICKERS[2].size },
        
        // Row 2
        { x: '70%', baseY: 700, speed: 0.35, rotate: -10, src: STICKERS[0].src, size: STICKERS[0].size },
        { x: '15%', baseY: 900, speed: 0.6, rotate: 25, src: STICKERS[1].src, size: STICKERS[1].size },
        { x: '90%', baseY: 1100, speed: 0.45, rotate: -20, src: STICKERS[2].src, size: STICKERS[2].size },
        ...
        { x: '20%', baseY: 1700, speed: 0.4, rotate: 15, src: STICKERS[2].src, size: STICKERS[2].size },
        
        // Row 4
        { x: '60%', baseY: 1900, speed: 0.35, rotate: -5, src: STICKERS[0].src, size: STICKERS[0].size },
        { x: '30%', baseY: 2100, speed: 0.5, rotate: 20, src: STICKERS[1].src, size: STICKERS[1].size },
        { x: '75%', baseY: 2300, speed: 0.3, rotate: -15, src: STICKERS[2].src, size: STICKERS[2].size },
    ];
