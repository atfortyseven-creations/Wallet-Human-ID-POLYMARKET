            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-[#1F1F1F]/60 max-w-3xl mx-auto font-light leading-relaxed">
                        Múltiples wallets, un ecosistema unificado. La simplicidad que esperabas.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    <FeatureCard
                        ...
                        description="Administra múltiples identidades con un solo toque. Sin fricción."
                        delay={0}
                    />
                    <FeatureCard
            ...
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    <h2 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-[#1F1F1F] uppercase leading-tight">
                        Descarga <br className="md:hidden" /> Human Wallet <br className="hidden md:block" /> Para Empezar
                    </h2>
