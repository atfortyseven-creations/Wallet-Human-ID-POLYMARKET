...
export function EnterpriseFooter() {
    ...
    const handleNewsletterSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('¡Gracias! Revisa tu email para confirmar.');
            setEmail('');
        } catch (error) {
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                >
                    <h2 className="text-5xl md:text-6xl font-black text-white mb-4 tracking-tight">
                        Descarga <span className="bg-gradient-to-r from-yellow-300 to-orange-400 bg-clip-text text-transparent">Human Wallet</span>
                    </h2>
                    ...
                    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8">
                        ...
                        {!isSubscribed ? (
                            ...
                            <div className="flex items-center gap-3 bg-green-500/20 border border-green-400/30 rounded-xl px-4 py-3">
                                ...
                                <span className="text-green-100 font-medium">¡Suscripción exitosa! Revisa tu email.</span>
                            </div>
                        )}
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    <FooterColumn
                        ...
                        links={[
                            ...
                            { label: 'Human Card', href: '/tarjeta-human' },
                ...
                <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="text-white/70 text-sm font-mono">
                        © 2026 Human DeFi Corp. All rights reserved.
                    </div>
