...
export function LedgerImpactOverlay({ active, data, onComplete }: LedgerImpactProps) {
    useEffect(() => {
        if (active) {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            {isMega ? 'Critical Elite Impact' : 'Ledger Activity Detected'}
                        </motion.div>
                    </motion.div>
