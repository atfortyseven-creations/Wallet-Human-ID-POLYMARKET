...
export function NativeSendView({ onBack }: { onBack: () => void }) {
    ...
    const [selectedToken, setSelectedToken] = useState<UniversalToken>(UNIVERSAL_TOKENS.find(t=>t.symbol==='ETH') || UNIVERSAL_TOKENS[0]);
