  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-900/10 bg-zinc-900/[0.015]">
        <div className="flex items-center gap-3">
          <div className="relative">
            <img src="/system-shots/aztec-logo.png" className="w-8 h-8 object-contain transition-transform" style={{ imageRendering: 'auto', filter: 'drop-shadow(0px 2px 4px rgba(0,0,0,0.1))' }} alt="Aztec" />
          </div>
          <div>
