...
describe("LedgerDeadmanSwitch", function () {
    let contract: any;
    let mockERC20: any;
    let mockERC721: any;
    ...
    beforeEach(async function () {
        ...
        // Deploy LedgerDeadmanSwitch
        const Switch = await ethers.getContractFactory("LedgerDeadmanSwitch");
