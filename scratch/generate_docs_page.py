...
page_code = '''import { ALL_DOC_SLUGS } from '@/components/docs/DocsData';
...
const CONTENT_MAP: Record<string, string> = %s;
...
with open('app/docs/[slug]/page.tsx', 'w', encoding='utf-8') as f:
    f.write(page_code % json.dumps(CONTENT_MAP, indent=2))
