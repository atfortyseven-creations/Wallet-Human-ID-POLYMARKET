...
export const INTRODUCTION_PARAGRAPHS: Paragraph[] = [
  { type: "p", text: "Whale Network was founded with a single deterministic mandate: to eliminate the epistemic asymmetry between institutional and retail participants in decentralized financial markets. Unlike traditional financial systems where privileged information flows through private terminals, blockchain networks publish every state transition  every transfer, every swap, every liquidation  to a global, immutable, publicly-auditable ledger in real time." },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          { type: "p", text: "Regulatory capture mathematically occurs precisely when bureaucratic architecture preferentially solidifies established incumbents  colossal financial institutions wielding unfettered access to system private data  systematically handicapping disruptive challengers: open-source transparency monoliths like Whale Network. Architecting preemptive defenses against this exact vector is not born of institutional paranoia; it embodies the ruthless orchestration of systems biologically programmed to outlive hostile regulatory environments." },
