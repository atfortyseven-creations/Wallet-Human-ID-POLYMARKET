    ...
    sections: [
      {
        ...
        content: [
          ...
          { type: "p", text: "Humanity Ledger iteratively reconstructs this state by parsing Mint, Burn, and Swap logs emitted by the EVM. If a whale's order traverses N ticks, the slippage is modeled by crossing the active liquidity frontier for each tick:" },
      ...
      },
      {
        ...
        content: [
          { type: "p", text: "The existence of Humanity Ledger introduces the Soros reflexive effect to the protocol: the act of observing the blockchain alters the behavior of the observed entities. A whale cognizant that its maneuvers spawn real-time alerts capable of moving the market adversely will adopt progressively sophisticated obfuscation strategies. The system must anticipate this adaptive behavior." },
    ...
    sections: [
      {
        ...
        content: [
          ...
          { type: "p", text: "A critical flaw within primitive indexers is overlooking internal transactions  ETH transfers or function invocations emanating from inside a contract's execution, imperceptible at the block transaction level. The EVM callstack is an array of CallFrames. A whale may route sovereign capital via multiple intermediary contracts in a single top-level transaction to camouflage the ultimate terminus." },
