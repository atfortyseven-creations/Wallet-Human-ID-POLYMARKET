...
export default function SettingsPage() {
    return (
        <div className="bg-transparent text-[#0A0A0A] dark:text-[#FFFFFF] font-mono selection:bg-black selection:text-white flex flex-col relative py-12 px-4 md:px-8 max-w-[1400px] mx-auto w-full">
