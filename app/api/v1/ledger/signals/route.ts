...
/**
 * @api {get} /api/v1/ledger/signals Advanced Elite Signals
 * Returns Heikin-Ashi trends and Z-Score anomalies.
 */
export async function GET(req: NextRequest) {
  const endpoint = '/api/v1/ledger/signals';
  ...
  try {
    ...
    return NextResponse.json({
      ...
      attribution: "Proprietary Analytics by Humanity Ledger Corporation."
    });
