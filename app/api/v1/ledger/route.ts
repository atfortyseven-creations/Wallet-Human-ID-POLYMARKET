...
// [PRODUCTION] Public V1 Ledger API
// "Ledger Real Time" - 100% Data Integrity
...
export async function GET(req: NextRequest) {
  ...
  try {
      ...
      // [LOGIC] Fetch Real Ledger Data
      // Use Singleton Service for connection pooling
      const { ledgerService } = await import('@/lib/services/ledger-data');
      
      const alerts = await ledgerService.getLatestLedgerActivity(
          25,       // Limit
