...
/**
 * GET /api/ledger/alerts/check?userId=...
    ...
    try {
        ...
        for (const wallet of watchedWallets) {
            ...
            for (const tx of transfers.transfers) {
                ...
                // Check against rules
                // STARTING SIMPLE: If rule name contains "Ledger" and value > $1000, trigger.
                ...
                generatedAlerts.push({
                    id: tx.hash,
                    type: isBigMove ? 'ledger_move' : 'smart_sell',
                    walletLabel: wallet.label,
                    walletAddress: wallet.address,
                    title: isBigMove ? ' Ledger Movement Detected' : ' Wallet Activity',
