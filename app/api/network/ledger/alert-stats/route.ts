...
// 
// /api/network/ledger/alert-stats  Real Alert Counter Statistics
// Counts actual ledger events recorded in the Prisma DB + derives
...
export async function GET() {
    try {
        ...
        // Ethereum activity from our tracked ledger events
