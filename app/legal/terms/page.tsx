      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <Article number="1" title="Definitions & Interpretation">
          ...
          <Clause id="def-cryptographic-assets" title="1.3 Cryptographic Assets">
            <p>&quot;Cryptographic Assets&quot; means any tokens, notes, commitments, digital assets, or cryptographic representations of value held in Aztec private notes or associated smart contract state, including but not limited to: shielded tokens, Quantum Dust (QD), and NFT representations of Studio Provenance records.</p>
          </Clause>
