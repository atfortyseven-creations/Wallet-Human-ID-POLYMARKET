      ...
      <div className="space-y-10 sm:space-y-14 text-black">
        ...
        <section id="whale-network-humanidfi-com">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            ...
            <p>
              <strong className="text-black font-semibold">Version:</strong> 2.1 (English) | <strong className="text-black font-semibold">Date:</strong> 20 July 2026 | <strong className="text-black font-semibold">Entry into Force:</strong> Upon publication on the website
            </p>
