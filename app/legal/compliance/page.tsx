...
const TOC: TocItem[] = [
  ...
  { id: 'section-3-aml-kyc', label: '3. AML/CFT & KYC Attestation' },
    ...
    >
      <div className="space-y-10 sm:space-y-14 text-black">
        ...
        <section id="section-2-platform">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
              The following documents are mandatorily published on humanidfi.com pursuant to Spanish and EU law. All texts are technically drafted and reviewed for GDPR, LSSI-CE, and MiCA attestation. 
            </p>
            <div className="space-y-3">
        ...
        <section id="section-3-aml-kyc">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            ...
            <div className="space-y-3">
              ...
              <DocRow number="20" title="Data Processing Agreement, DPA (Sumsub)" status="complete" version="v2.0" authority="AEPD / GDPR Art. 28" description="GDPR Article 28 Data Processing Agreement to be executed with Sumsub Ltd. (KYC provider) as data processor, covering biometric identity verification data and liveness check results. Template is available directly in the Sumsub cryptographic dashboard. Also to be executed with any additional sub-processors (hosting providers, monitoring services)."  />
            </div>
          </div>
        </section>
        ...
        <section id="section-5-agreements">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <div className="space-y-3">
              ...
              <DocRow number="21" title="Intellectual Property Assignment Agreement" status="complete" version="v2.0" description="Agreement assigning all intellectual and industrial property rights in the Whale Network platform codebase, Noir smart contracts ($QDs token contract, mint_private_license circuit), graphical assets, attest marks, and all related technology to Humanity Ledger S.L. Mandatory for all contributing developers." />
              <DocRow number="24" title="Non-Disclosure Agreement (NDA)" status="ready" version="v2.0" description="Standard bilateral NDA for third-party disclosures. Applicable to: ZK security auditors (Nethermind Security, Sentnl, Trail of Bits), potential exchange partners, sovereign investors, and technology integration partners. Governing law: Kingdom of Spain. Jurisdiction: Courts of Valencia. Confidentiality period: 5 years from signature date. Carve-outs: information already in the public domain; information disclosed pursuant to a regulatory or judicial order." note="Ready to use as-is. Execute before any third-party disclosure of technical or commercial confidential information." />
        ...
        <section id="section-9-timeline">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
              Corporate name reservation is finalised. S.L. constitution is fully executed. NIF (Tax ID) is pending.
            </p>
          </div>
        </section>
