    ...
    >
      <div className="space-y-10 sm:space-y-14 text-black">
              ...
              <table className="min-w-full border text-sm text-left">
                <tbody className="divide-y divide-black/10">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">Contributing our compliance-focused Noir circuit templates (Travel Rule compliance, biometric gating) back to the Aztec developer community as open-source primitives.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="final-declaration">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
              We are building the definitive bridge between extreme cypherpunk privacy (Aztec) and strict institutional compliance (MiCA). We require Aztec's backing specifically to fund the heavy security auditing and infrastructure scaling required to bring this blueprint to life securely on the Aztec Network.
            </p>
          </div>
        </section>
