...
const TOC: TocItem[] = [
  ...
  { id: 'viewing-keys-aml', label: '3. Viewing Keys & AML Attestation' },
    ...
    >
      <div className="space-y-10 sm:space-y-14 text-black">
        ...
        <section id="viewing-keys-aml">
          <h2 className="text-[1.1rem] font-bold uppercase tracking-[0.08em] text-black mb-6 pb-3 border-b border-black/10">
            3. Viewing Keys & AML Attestation (Travel Rule)
          </h2>
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>The user securely delegates the <code>viewing_public_key</code> to Humanity Ledger S.L.'s internal attestation module.</li>
              <li>Transactions executed by the user remain completely private on the global public ledger. However, the designated Attestation Officer, utilizing the escrowed viewing key, retains the technical capacity to decrypt the specific user's transaction graph.</li>
