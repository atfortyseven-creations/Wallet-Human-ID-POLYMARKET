...
export default function AboutPage() {
  return (
    <LegalDocLayout
      title="About Us"
      subtitle="The mission, vision, and people behind Humanity Ledger S.L. and our flagship platform, Humanity Ledger — built to make advanced decentralised finance accessible, transparent, and secure for everyone."
    ...
    >
      <div className="space-y-10 sm:space-y-14 text-black">
        ...
        <section id="global-reach">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
              Humanity Ledger is not confined by geopolitical borders. Our infrastructure is deployed across multiple regions, ensuring low-latency access and uninterrupted service for a truly global user base. We are actively localising our analytics engine to support multiple international languages and region-specific regulatory frameworks.
            </p>
            <p>
        ...
        <section id="open source-aztec">
          ...
          <div className="space-y-4 text-[15px] leading-[1.75] text-black/70">
            <p>
              Humanity Ledger is entirely <strong>Open Source</strong>. We believe that true financial Privatety and privacy can only be achieved when the underlying code is fully transparent, auditable, and verifiable by the community. We do not commercialise the system; our goal is to provide a robust, production-ready public good for the decentralised ecosystem.
            </p>
            <p>
